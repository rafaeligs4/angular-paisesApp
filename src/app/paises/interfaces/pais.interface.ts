...
//
//   const searchCountries = Convert.toSearchCountries(json);
//
...
export class Convert {
    public static toSearchCountries(json: string): SearchCountries[] {
        return cast(JSON.parse(json), a(r("SearchCountries")));
    }

    public static searchCountriesToJson(value: SearchCountries[]): string {
        return JSON.stringify(uncast(value, a(r("SearchCountries"))), null, 2);
    }
}
